...
/*    public static void main(String args[]) {
    ...
    public static void main(String args[]) {
        ...
        if(args != null & args.length > 0){
            ...
            int anoBase2 = 2004;               //aÐo base
            int anoAEvaluar2 = anoBase2;           //aÐo a evaluar
            int tipoCalcSeleccionado2 = 1;  // tipo de calculo
            int numHidro2 = 49;              //numero de hidrologias
            int numEtapasAno2 = 240;          //numero de etapas por aÐo
            ...
            if (argsMap.containsKey("-h")){
                System.out.println("Uso: java -jar -Xmx900m PeajesCDECSIC.jar [-par‡metros]\n\n"
                        ...
                        + "-hid hidrolog’as\tNœmero de hidrolog’as\n"
                        ...
                        + "-abase aÐo\t\tA–o basae.\n"
                        + "-aev aÐo\t\tA–o a evaluar.\n"
                        + "-etapas etapas\t\tNœmero de etapas por a–o (defecto 240).\n"
